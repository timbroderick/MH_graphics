...
Highcharts.setOptions({
  ...
  var chartRate = new Highcharts.Chart({
      ...
      tooltip: {
        ...
        pointFormat: '<table style="width:100%;"><tbody>' +
        '<tr style="border-top: 1px solid #ddd;"><td class="tdLEFT" style="padding:2px; margin:2px; background-color: #fff;">Total rural hospitals: </td><td style="padding:2px; margin:2px; background-color: #fff;"><strong>{point.total}</strong></td></tr>' +
        '<tr style="border-top: 1px solid #ddd;"><td class="tdLEFT" style="padding:2px; margin:2px; background-color: #eee;">Number at risk: </td><td style="padding:2px; margin:2px; background-color: #eee;"><strong>{point.risk}</strong></td></tr>' +
        '<tr style="border-top: 1px solid #ddd;"><td class="tdLEFT" style="padding:2px; margin:2px; background-color: #fff;">Percentage at risk: </td><td style="padding:2px; margin:2px; background-color: #fff;"><strong>{point.legend}</strong></td></tr>' +
        '</table>'
      },
      plotOptions: {
        series: {
