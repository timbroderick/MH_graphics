Highcharts.setOptions({
  ...
  var chartRate = new Highcharts.Chart({
      ...
      colorAxis: {
        dataClasses: [{
          ...
          // #018571
            ...
            to: 1.5,
            color: '#a6611a',
            name: 'Considering buy-in/<br>public option legislation'
        }, {
            from: 1.5,
            to: 2.5,
            color: '#dfc27d',
            name: 'Considering study<br>legislation'
        }, {
            from: 2.5,
            to: 3.5,
            color: '#ffedb3',
            name: 'Considering both'
        }, {
            from: 3.5,
            to: 4.5,
            color: '#80cdc1',
            name: 'Passed study<br>legislation'
        }, {
            from: 4.5,
            to: 5.5,
            color: '#018571',
            name: 'Passed buy-in/<br>public option legislation'
        }, {
            from: -1,
            to: 0,
            color: "#DDDDDD",
      ...
      tooltip: {
        ...
        headerFormat: null,
        pointFormat: '<h5><strong>{point.name}</strong></h5>' +
              '{point.legend}'
      },
      plotOptions: {
        series: {
