    ...
    Highcharts.setOptions({
      ...
      var chartRate1 = new Highcharts.Chart({
          ...
          tooltip: {
              ...
              formatter: function() {
                    ...
                    '<tr style="border-top: 1px solid #ddd; background-color: #fff;"><td class="tdLEFT" style="padding:2px; margin:2px;">' +  DATA[this.point.x].q1 + ': </td><td style="padding:2px; margin:2px;"><strong>' + DATA[this.point.x].a1 + '%</strong></td></tr>' +
                      '</table>';
              },
          },
      });
      ...
      var chartRate2 = new Highcharts.Chart({
          ...
          tooltip: {
              ...
              formatter: function() {
                    return '<table style="width:100%;"><tbody>' +
                    '<tr style="border-top: 1px solid #ddd; background-color: #fff;"><td class="tdLEFT" style="padding:2px; margin:2px;">' +  DATA[this.point.x].q2 + ': </td><td style="padding:2px; margin:2px;"><strong>' + DATA[this.point.x].a2 + '%</strong></td></tr>' +
                      '</table>';
              },
          },
      });
      ...
      var chartRate4 = new Highcharts.Chart({
          ...
          xAxis: {
            categories:  [ DATA[0].q4,DATA[1].q4,DATA[2].q4,DATA[3].q4,DATA[4].q4 ],
            labels: {
              staggerLines: 2
            },
            title: {
          ...
          series: [{
            name: "Now",
            color: '#508ebc',
            data: $.map( [DATA[0].a4,DATA[1].a4,DATA[2].a4,DATA[3].a4,DATA[4].a4], function(datavalue) {
              return isNaN(datavalue) ? {y:null} : parseFloat(datavalue); })
          }],
          tooltip: {
              crosshairs: true,
