  ...
  var chartRate = new Highcharts.Chart({
      ...
      tooltip: {
          ...
          formatter: function() {
                ...
                '<tr style="border-top: 1px solid #ddd; background-color: #fff;"><td class="tdLEFT" style="padding:2px; margin:2px;">' + DATA[this.point.x].year + ':</td><td style="padding:2px; margin:2px;"><strong>' + DATA[this.point.x].percent + '%</strong></td></tr>' +
                '</table>';
          },
      },
  });
