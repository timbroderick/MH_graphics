  ...
  var chartRate = new Highcharts.Chart({
      ...
      tooltip: {
        ...
        pointFormat: '<h5><strong>{point.name}</strong></h5><table style="width:100%;"><tbody>' +
              '<tr style="border-top: 1px solid #ddd; background-color: #fff;"><td class="tdLEFT" style="padding:2px; margin:2px;">Percentage of revenue<br>from Section 330 grants: </td><td style="padding:2px; margin:2px;"><strong><br>{point.legend}</strong></td></tr>' +
              '</table>'
      },
      plotOptions: {
        series: {
